    ...
    new WOW().init();
      ...
      var object = [

        {
          ...
          'headline':'JAVA & KOTLIN',
          'value':8,
          'length':9,
          'description':'Over four years experience and knowledge in Android development using Android Studio, Java and Kotlin languages.'
        ...
        },
        {
          ...
          'headline':'UI/UX Design (Figma)',
          'value':6,
          'length':6,
          'description':'Experience with Figma software and currently learning Adobe XD. </br> Extended knowlage of DOM manipulation in aiding and extending the UI.'
